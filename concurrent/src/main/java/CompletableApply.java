...
public class CompletableApply {
    public static void main(String[] args) {
        CompletableFuture<Machina> cf = CompletableFuture.completedFuture(new Machina(2));
        CompletableFuture<Machina> cf2 =
                cf.thenApplyAsync(Machina::work);
        CompletableFuture<Machina> cf3 =
                cf2.thenApplyAsync(Machina::work);
        CompletableFuture<Machina> cf4 =
                cf3.thenApplyAsync(Machina::work);
